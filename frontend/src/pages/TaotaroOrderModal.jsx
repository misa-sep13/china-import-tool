...
// 「その他のご要望」に定型文を入れて頼む。新商品の商品紹介動画に
// そのまま使える品質のものが欲しい、という用途なのでそこまで書く。
// 日本語だけでは伝わらないので中国語を添える
const VIDEO_REQ = '動画撮影をお願いします。全体・動作等が分かるもので商品紹介動画として使えるレベルのもの／请拍摄视频：需展示整体和使用动作，品质要可以直接用作商品介绍视频'
